...
interface SeedCompanyDef {
  ...
  tier: NonNullable<CompanyInput['tier']>;
  hpUrl: string;
}

// 業界・Tierは 616社マスタシート（採用難易度Tier_エントリー数推定_616社）の値に合わせている
const COMPANY_DEFS: SeedCompanyDef[] = [
  { key: 'mitsui', name: '三井物産', industry: '総合商社', tier: 'S+', hpUrl: 'https://www.mitsui.com/jp/ja/recruit/' },
  { key: 'mitsubishi-corp', name: '三菱商事', industry: '総合商社', tier: 'S', hpUrl: 'https://www.mitsubishicorp.com/jp/ja/recruit/' },
  { key: 'itochu', name: '伊藤忠商事', industry: '総合商社', tier: 'S', hpUrl: 'https://www.itochu.co.jp/ja/recruit/' },
  { key: 'bcg', name: 'ボストンコンサルティンググループ', industry: '外資コンサル', tier: 'SS+', hpUrl: 'https://www.bcg.com/ja-jp/careers' },
  { key: 'mckinsey', name: 'マッキンゼー・アンド・カンパニー', industry: '外資コンサル', tier: 'SS+', hpUrl: 'https://www.mckinsey.com/jp/careers' },
  { key: 'accenture', name: 'アクセンチュア', industry: 'コンサル', tier: 'A+', hpUrl: 'https://www.accenture.com/jp-ja/careers' },
  { key: 'pwc', name: 'PwCコンサルティング', industry: 'コンサル', tier: 'S', hpUrl: 'https://www.pwc.com/jp/ja/careers.html' },
  { key: 'goldman', name: 'ゴールドマン・サックス証券', industry: '外資金融', tier: 'SS+', hpUrl: 'https://www.goldmansachs.com/careers/' },
  { key: 'nomura', name: '野村證券', industry: '証券', tier: 'A+', hpUrl: 'https://www.nomura.co.jp/recruit/' },
  { key: 'mufg', name: '三菱UFJ銀行', industry: '銀行', tier: 'A+', hpUrl: 'https://www.bk.mufg.jp/recruit/' },
  { key: 'toyota', name: 'トヨタ自動車', industry: '自動車', tier: 'A', hpUrl: 'https://toyota.jp/recruit/' },
  { key: 'sony', name: 'ソニーグループ', industry: '電機精密', tier: 'A+', hpUrl: 'https://www.sony.com/ja/SonyInfo/recruit/' },
  { key: 'panasonic', name: 'パナソニック', industry: '電機精密', tier: 'A', hpUrl: 'https://recruit.panasonic.com/' },
  { key: 'keyence', name: 'キーエンス', industry: '電機精密', tier: 'A', hpUrl: 'https://www.keyence.co.jp/recruit/' },
  { key: 'nintendo', name: '任天堂', industry: 'エンタメ（ゲーム）', tier: 'A+', hpUrl: 'https://www.nintendo.co.jp/jobs/' },
  { key: 'dentsu', name: '電通', industry: '広告', tier: 'S', hpUrl: 'https://www.dentsu.co.jp/recruit/' },
  { key: 'hakuhodo', name: '博報堂', industry: '広告', tier: 'S', hpUrl: 'https://www.hakuhodo.co.jp/recruit/' },
  { key: 'nttdata', name: 'NTTデータ', industry: 'IT', tier: 'A+', hpUrl: 'https://nttdata-recruit.com/' },
  { key: 'recruit', name: 'リクルート', industry: 'メガベンチャー（サービス）', tier: 'A', hpUrl: 'https://recruit-saiyo.jp/' },
  { key: 'rakuten', name: '楽天グループ', industry: 'IT', tier: 'A', hpUrl: 'https://corp.rakuten.co.jp/careers/' },
  { key: 'cyberagent', name: 'サイバーエージェント', industry: '広告', tier: 'A+', hpUrl: 'https://www.cyberagent.co.jp/careers/' },
  { key: 'lineyahoo', name: 'LINEヤフー', industry: '外資IT', tier: 'A', hpUrl: 'https://www.lycorp.co.jp/ja/recruit/' },
];
...
const ENTRY_DRAFTS: EntryDraft[] = [
  ...
  { companyKey: 'itochu', title: '業界研究セミナー', type: '説明会・イベント', gradYear: 2028, days: 3, hh: 19, mm: 0, description: 'オンライン開催の業界研究セミナーです。質疑応答の時間もあります。' },
  ...
  { companyKey: 'mckinsey', title: 'サマープログラム', type: 'インターン', gradYear: 2028, days: 15, description: '選考倍率が非常に高い難関プログラム。エントリーシートに加え適性検査があります。', selectionFlow: 'ES提出 → 適性検査 → ケース面接（複数回）', webTest: 'Solve（マッキンゼー独自）' },
  { companyKey: 'accenture', title: 'テクノロジーコンサルタント職 説明会', type: '説明会・イベント', gradYear: 2028, days: 5, hh: 18, mm: 30, description: 'テクノロジー領域のコンサルティング職種紹介イベントです。' },
  ...
  { companyKey: 'goldman', title: 'サマーアナリストプログラム', type: 'インターン', gradYear: 2028, days: 20, pickup: true, description: '投資銀行部門の業務を体験する10週間のサマーアナリストプログラム。', selectionFlow: 'ES提出（英文レジュメ含む） → Webテスト → 面接（複数回）', webTest: 'SHL形式（玉手箱型）', eventStartDays: 45, eventDays: 70 },
  ...
  { companyKey: 'mufg', title: '本選考エントリー（第一クール）', type: '本選考', gradYear: 2027, days: 25, description: '本選考第一クールのエントリーシート受付です。' },
  ...
  { companyKey: 'keyence', title: '会社説明会', type: '説明会・イベント', gradYear: 2028, days: 2, hh: 14, mm: 0, description: '高収益経営の秘密に迫るオンライン会社説明会です。' },
  { companyKey: 'nintendo', title: 'サマーインターンシップ', type: 'インターン', gradYear: 2028, days: 30, description: 'ゲーム開発の企画・プログラム・デザイン各コースのインターンです。' },
  ...
  { companyKey: 'recruit', title: 'ビジネスコースインターン', type: 'インターン', gradYear: 2028, days: 4, description: '新規事業提案にチャレンジするビジネスコースのインターンです。', selectionFlow: 'ES提出 → Webテスト → 面接（2回）', webTest: 'SPI' },
      ...
      configJson: JSON.stringify(
        {
          ...
          defaults: { type: 'インターン', gradYear: 2028 },
          limit: 50,
        },
        null,
        2,
